...
namespace ConditionalField
{
	...
	/// 
	/// Use this functionality by writing:
	/// public bool myBool;
	/// [ConditionalField("myBool")] public float myFloat = 5;
	/// 
	/// </summary>
...
#if UNITY_EDITOR
namespace ConditionalField.Internal
{
	using UnityEditor;
	...
	public static class ConditionalFieldUtility
	{
		...
		public static bool PropertyIsVisible(SerializedProperty property, bool inverse, string[] compareAgainst)
		{
			...
			bool IsFlagsEnum()
			{
				...
				var value = property;        //Modified from: var value = property.GetValue(); 
